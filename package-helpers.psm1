...
function Get-VersionNumber {
    ...
    "dmscs-v=$version" | Out-File -FilePath $env:GITHUB_OUTPUT -Append
    "dmscs-semver=$($version -Replace $prefix)" | Out-File -FilePath $env:GITHUB_OUTPUT -Append
}
...
function Invoke-Promote {
    ...
    $package = "EdFi.DmsConfigurationService"
